...
def main():
    ...
    filenames = ['TableS13_NonRBP_SR-relatedProteins_GOresults', 'Fig1D_NewRBPs_LCprotsExcluded', 'FigS3B_NewRBPs_LC-MixedChargeProtsExcluded', 'FigS3D_NewRBPs_LC-MouseHomologProtsExcluded', 'TableS2_GOterm_Results_LongAndCaceres_Proteins', 'TableS3_Human_R-richOnly_GOterm_Results', 'TableS4_Human_S-richOnly_GOterm_Results']
