...
def main():
    ...
    for s_comp in range(20, 105, 5):
        for r_comp in range(20, 105, 5):
            ...
            output.write('python LCD-Composer.py UP000005640_9606_additional_FragmentsRemoved.fasta Human_S-R_' + str(s_comp) + '-' + str(r_comp) + '_RESULTS_Additional_Isoforms -a S_R -c ' + str(s_comp) + '_' + str(r_comp) + '\n')
