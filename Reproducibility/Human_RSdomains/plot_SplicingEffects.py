...
def plot_differentially_expressed(df, annotation_type, labels):
    ...
    plt.savefig('Fig4G_' + annotation_type + '_DifferentiallyExpressed_Barplot.tif', bbox_inches='tight', dpi=600)
    plt.close()
...
def plot_splicing_effects(df, annotation_type, labels):
    ...
    plt.savefig('Fig4I_' + annotation_type + '_SplicingEffects_Barplot.tif', bbox_inches='tight', dpi=600)
    plt.close()
