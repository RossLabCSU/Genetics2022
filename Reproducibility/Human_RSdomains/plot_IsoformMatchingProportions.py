...
def plot_nonmatch(df):
    ...
    plt.savefig('Fig 3C - ProportionIsoformsWithRSdomain_for_NonMatchProts.tiff', bbox_inches='tight', dpi=600)
    plt.close()
...
def plot_isos_with_perfect_match(df):
    ...
    plt.savefig('Fig 3D - ProportionIsoformsWithRSdomain_for_IsosWithPerfectRSmatch.tiff', bbox_inches='tight', dpi=600)
    plt.close()
