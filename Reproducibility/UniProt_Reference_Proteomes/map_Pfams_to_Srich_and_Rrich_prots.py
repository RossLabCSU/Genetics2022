...
file_leaders = {'Archaea':{'R':'TableS13', 'S':'TableS17'}, 'Bacteria':{'R':'TableS14', 'S':'TableS18'}, 'Eukaryota':{'R':'TableS15', 'S':'TableS19'}, 'Viruses':{'R':'TableS16', 'S':'TableS20'}}
...
def main():
    ...
    for i in range(len(residues)):
        ...
        for domain in domains:
            ...
            for i in range(7):
                h.readline()
            output = open(file_leaders[domain][aa] + '_' + domain + '_' + aa + '-richOnly_WithPfamAnnotations.tsv', 'w')
